...
public class LeftArrowLocation implements ArrowLocation {
    ...
    public void ConfigureDraw(ToolTipView view, Canvas canvas) {
        ...
        view.getTooltipPath().moveTo(0f, middle);
        int arrowDy = view.getArrowHeight() / 2;
        view.getTooltipPath().lineTo( rectF.left, middle - arrowDy);
        view.getTooltipPath().lineTo(rectF.left, middle + arrowDy);
